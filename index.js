...
bot.onConversationStarted((userProfile, isSubscribed, context, onFinish) => {
	...
	const keyboard_policy = {
		...
		"Buttons": [{
			...
			"TextVAlign": "middle",
			"ActionType": "open-url",
			"ActionBody": "https://aeloop.com/termsprivacy ",
	...
	// },
	 {
		...
		"ActionType": "open-url",
		"TextSize": "medium",
		"ActionBody": "https://aeloop.com/about-aeloop",
		"OpenURLType": "internal",
		"Silent": "true",
		"BgColor": "#c7b0e6",
	}, {
		...
		"ActionType": "open-url",
		"TextSize": "medium",
		"ActionBody": "https://www.aeloop.com/faq",
		"OpenURLType": "internal",
		"Silent": "true",
		"BgColor": "#edbf80",
	}, {
		...
		try{
			...
			const newAccount2Kb = {
				...
				"Buttons": [{
					...
					"Columns": 3,
					"Rows": 1,
					"Text": "<font color=\"#494E67\"><b>aeloop.com</b></font>",
					"TextSize": "medium",
					"TextHAlign": "center",
					"TextVAlign": "middle",
					"ActionType": "reply",
